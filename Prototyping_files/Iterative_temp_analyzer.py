...
import datetime
work_dir = '/cluster/work/climate/dnikolo/n2o'
...
for i in range(len(min_temp_array)):
    ...
    temp_setup[
        'root_path'] = f'/cluster/work/climate/dnikolo/n2o/TEST/example_postprocessing/T-{round(abs(min_temp))}-{round(abs(max_temp))}'
