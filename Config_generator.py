#################################
# Python script to create config files from within job so that the config files can use TMPDIR
##################################
...
if __name__=="__main__":
    ...
    config_setup(base_dir, abs(round(arg_dict['temp_bounds'][0])), abs(round(arg_dict['temp_bounds'][1])), custom_setup)
