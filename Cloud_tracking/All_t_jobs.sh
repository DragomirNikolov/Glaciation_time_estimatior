...
for min_temp in $(seq $dt $dt 38); do
    ...
    for pole in "np" "sp"; do
        ...
        sbatch -J "$name" "$GTE_DIR"/Cloud_tracking/job.bsub -h $max_temp -l $min_temp -p $pole -c "/cluster/work/climate/dnikolo/n2o/Glaciation_time_estimator/config_w1.yaml"
