...
for dt in 3 5 6; do
    for min_temp in $(seq $dt $dt 38); do
        ...
        for pole in "np" "sp"; do
            ...
            sbatch -J "$name" "$GTE_DIR"/Cloud_tracking/Slurm_jobs/job.bsub -h $max_temp -l $min_temp -p $pole -c "/cluster/work/climate/dnikolo/n2o/Glaciation_time_estimator/configs/config_2022_0301_0315.yaml"
