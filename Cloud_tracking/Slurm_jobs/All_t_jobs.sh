...
if [ ${#job_ids[@]} -gt 0 ]; then
    ...
    sbatch --dependency=afterok:$dependency_list /cluster/work/climate/dnikolo/n2o/Glaciation_time_estimator/Data_postprocessing/postproc_job.bsub -c $GTE_CONFIG_DIR
fi
